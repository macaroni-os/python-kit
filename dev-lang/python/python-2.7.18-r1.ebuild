...
SRC_URI="https://www.python.org/ftp/python/2.7.18/Python-2.7.18.tar.xz -> Python-2.7.18.tar.xz"
...
SLOT="${PYVER}"
KEYWORDS="*"
IUSE="-berkdb bluetooth build elibc_uclibc examples gdbm hardened ipv6 libressl +ncurses +optimize +readline sqlite +ssl +threads tk +wide-unicode wininst +xml"
